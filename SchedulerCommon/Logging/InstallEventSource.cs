...
{
    [EventSource(Name = "Onevinn-DeploymentScheduler-Install")]
    public sealed class InstallEventSource : EventSource
    {
        public static readonly InstallEventSource Log = new InstallEventSource();
