...
namespace SchedulerCommon.ToastSystem
{
    public static class DesktopNotificationManagerCompat
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Justification ="Internet")]
        ...
        private static void EnsureRegistered()
        {
            ...
            if (!_registeredAumidAndComServer)
            {
                ...
                else
                {
                    ...
                    Globals.Log("You must call RegisterAumidAndComServer first.");
                }
                */
            }
    ...
    public abstract class NotificationActivator : NotificationActivator.INotificationActivationCallback
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible", Justification ="Internet")]
        [ComImport,
