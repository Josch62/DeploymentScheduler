...
{
    [EventSource(Name = "Onevinn-DeploymentScheduler-Desktop")]
    public sealed class DesktopEventSource : EventSource
    {
        public static readonly DesktopEventSource Log = new DesktopEventSource();

        private DesktopEventSource()
            : base()
        {
        }
