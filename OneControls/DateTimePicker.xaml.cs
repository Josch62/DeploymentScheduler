...
namespace OneControls
{
    ...
    {
        private static readonly string  _dateFormat = DateTimeFormatInfo.CurrentInfo.ShortTimePattern.Contains("H") ? "yyyy-MM-dd HH:mm" : "MM/dd/yyyy hh:mm tt";
        ...
        public static readonly DependencyProperty DateFormatProperty = DependencyProperty.Register("DateFormat", typeof(string), typeof(DateTimePicker), new FrameworkPropertyMetadata(_dateFormat, OnDateFormatChanged));
        ...
        DateTime? ParseDateText(bool flexible)
        {
            ...
            if (!DateTime.TryParseExact(DateDisplay.Text, InputDateFormat(), null, DateTimeStyles.AllowWhiteSpaces, out var selectedDate))
        ...
        void DateDisplay_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (date != null)
            {
                ...
                var newEventArgs = new RoutedEventArgs(DateChangedEvent);
        ...
        private static object CoerceMaxDate(DependencyObject d, object value)
        {
            ...
            if (current <= me.MinimumDate)
            {
                current = me.MinimumDate.AddMinutes(5);
            }
        ...
        private DateTime Increase(int selstart, int value)
        {
            ...
            if (DateDisplay.SelectedText.ToUpper().Equals("AM"))
            {
                return retval.AddHours(12);
            }

            if (DateDisplay.SelectedText.ToUpper().Equals("PM"))
            {
                return retval.AddHours(-12);
            }
            ...
            try
            {
                switch (DateFormat.Substring(selstart, 1))
                {
                    ...
                    case "M":
                        ...
                        break;
                    case "m":
                        retval = retval.AddMinutes(value < 0 ? value - 4 : value + 4);
                        break;
                    case "d":
    ...
    public class TextBoxUpDownAdorner : Adorner
    {
        ...
        public Pen Outline = new Pen(Brushes.Black, .1); // rgba(0, 181, 204, 1) new Pen(Brushes.LightBlue, 5);   // new Pen(new SolidColorBrush(Color.FromArgb(64, 255, 255, 255)), 5);
        public Brush Fill = Brushes.Aqua;
        ...
        public TextBoxUpDownAdorner(TextBox adornedBox) : base(adornedBox)
        {
            ...
            {
                c.BeginFigure(new Point(-8, 0), true /* filled */, true /* closed */);
                c.LineTo(new Point(8, 0), true, false);
